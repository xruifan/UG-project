...
def train_single_model(model: TransformerModelWrapper, train_data: List[InputExample], config: TrainConfig,
    ...
    if train_data and return_train_set_results:
        results_dict['train_set_before_training'] = evaluate(model, train_data, eval_config)['scores']['f1-macro']      # changed metrics to f1-macro
    ...
    if train_data and return_train_set_results:
        results_dict['train_set_after_training'] = evaluate(model, train_data, eval_config)['scores']['f1-macro']      # changed metrics to f1-macro
